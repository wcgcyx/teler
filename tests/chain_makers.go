...
// 		go-ethereum@v1.14.8/core/chain_makers.go
...
func (b *BlockGen) SetParentBeaconRoot(root common.Hash) {
	...
	var (
		blockContext = core.NewEVMBlockContext(b.header, b.cm, &b.header.Coinbase)
		vmenv        = vm.NewEVM(blockContext, vm.TxContext{}, b.statedb, b.cm.config, vm.Config{})
	)
	core.ProcessBeaconBlockRoot(root, vmenv, b.statedb)
}
...
func (b *BlockGen) addTx(bc *core.BlockChain, vmConfig vm.Config, tx *types.Transaction) {
	...
	receipt, err := core.ApplyTransaction(b.cm.config, bc, &b.header.Coinbase, b.gasPool, b.statedb, b.header, tx, &b.header.GasUsed, vmConfig)
	if err != nil {
		panic(err)
	}
...
func GenerateChainWithGenesis(genesis *core.Genesis, engine consensus.Engine, n int, gen func(int, *BlockGen)) (ethdb.Database, []*types.Block, []types.Receipts) {
...
func GenerateVerkleChainWithGenesis(genesis *core.Genesis, engine consensus.Engine, n int, gen func(int, *BlockGen)) (ethdb.Database, []*types.Block, []types.Receipts, []*verkle.VerkleProof, []verkle.StateDiff) {
	db := rawdb.NewMemoryDatabase()
